/// Transparent drag-bar child window for custom titlebar dragging (XAML Islands variant).
///
...
///
/// In the XAML Islands architecture, the parent HWND is our own CreateWindowEx
/// window (not a WinUI3-managed HWND), so WS_EX_LAYERED works correctly.
