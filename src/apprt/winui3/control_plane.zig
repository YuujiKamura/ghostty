...
pub const ControlPlane = struct {
    ...
    fn initDll(self: *ControlPlane) !void {
        ...
        // Pipe prefix for ghostty
        const pipe_prefix_z: [*:0]const u8 = "ghostty-winui3";

        // Build VTable with extern "C" callbacks pointing back to self
        const vtable = TerminalProviderVTable{
        ...
        log.info("control plane DLL started successfully", .{});
    }
