...
pub const IVector = extern struct {
    ...
    pub fn getSize(self: *@This()) !u32 {
        var out: u32 = 0;
        try hrCheck(self.lpVtbl.get_Size(self, &out));
        return out;
    }
    pub fn getAt(self: *@This(), i: u32) !*anyopaque {
        var out: ?*anyopaque = null;
        try hrCheck(self.lpVtbl.GetAt(self, i, &out));
        return out orelse error.WinRTFailed;
    }
    pub fn insertAt(self: *@This(), i: u32, item: ?*anyopaque) !void {
        try hrCheck(self.lpVtbl.InsertAt(self, i, item));
    }
    pub fn append(self: *@This(), item: ?*anyopaque) !void {
        try hrCheck(self.lpVtbl.Append(self, item));
    }
    pub fn removeAt(self: *@This(), i: u32) !void {
        try hrCheck(self.lpVtbl.RemoveAt(self, i));
    }
    pub fn clear(self: *@This()) !void {
        try hrCheck(self.lpVtbl.Clear(self));
    }
...
pub const IPropertyValue = extern struct {
    ...
    pub fn getString(self: *@This()) !HSTRING {
        var out: HSTRING = null;
        try hrCheck(self.lpVtbl.GetString(self, &out));
        return out;
    }
};
...
pub const IPropertyValueStatics = extern struct {
    ...
    pub fn createString(self: *@This(), s: HSTRING) !*IInspectable {
        var out: ?*anyopaque = null;
...
pub const IPointerRoutedEventArgs = extern struct {
    ...
    pub fn Pointer(self: *@This()) !*gen.IPointer {
        var out: ?*anyopaque = null;
        try hrCheck(self.lpVtbl.get_Pointer(@ptrCast(self), &out));
        return @ptrCast(@alignCast(out orelse return error.WinRTFailed));
    }
...
pub const IPointerPoint = extern struct {
    ...
    /// Returns the PointerDeviceType: 0=Touch, 1=Pen, 2=Mouse.
    /// Maps to Microsoft.UI.Input.PointerDeviceType enum.
    pub fn PointerDeviceType(self: *@This()) !i32 {
        var out: i32 = 0;
        try hrCheck(self.lpVtbl.get_PointerDeviceType(@ptrCast(self), &out));
        return out;
    }
};
...
pub const IPointerPointProperties = extern struct {
    ...
    pub fn IsLeftButtonPressed(self: *@This()) !bool {
        var out: bool = false;
        try hrCheck(self.lpVtbl.get_IsLeftButtonPressed(@ptrCast(self), &out));
        return out;
    }
    pub fn IsRightButtonPressed(self: *@This()) !bool {
        var out: bool = false;
        try hrCheck(self.lpVtbl.get_IsRightButtonPressed(@ptrCast(self), &out));
        return out;
    }
    pub fn IsMiddleButtonPressed(self: *@This()) !bool {
        var out: bool = false;
        try hrCheck(self.lpVtbl.get_IsMiddleButtonPressed(@ptrCast(self), &out));
        return out;
    }
    pub fn MouseWheelDelta(self: *@This()) !i32 {
        var out: i32 = 0;
        try hrCheck(self.lpVtbl.get_MouseWheelDelta(@ptrCast(self), &out));
        return out;
    }
    pub fn IsHorizontalMouseWheel(self: *@This()) !bool {
        var out: bool = false;
        try hrCheck(self.lpVtbl.get_IsHorizontalMouseWheel(@ptrCast(self), &out));
        return out;
    }
    pub fn PointerUpdateKind(self: *@This()) !i32 {
        var out: i32 = 0;
        try hrCheck(self.lpVtbl.get_PointerUpdateKind(@ptrCast(self), &out));
        return out;
    }
    pub fn ContactRect(self: *@This()) !Rect {
        var out: Rect = .{ .X = 0, .Y = 0, .Width = 0, .Height = 0 };
        try hrCheck(self.lpVtbl.get_ContactRect(@ptrCast(self), &out));
        return out;
    }
};
...
pub const ISwapChainPanelNative = extern struct {
    ...
    pub fn queryInterface(self: *ISwapChainPanelNative, comptime T: type) !*T {
        return comQueryInterface(self, T);
    }
    pub fn setSwapChain(self: *@This(), sc: ?*anyopaque) !void {
...
pub const IWindowNative = extern struct {
    ...
    pub fn getWindowHandle(self: *@This()) !*anyopaque {
        var h: ?*anyopaque = null;
        try hrCheck(self.lpVtbl.getWindowHandle(self, &h));
        return h orelse error.WinRTFailed;
    }
};
...
pub const ISplitButton = extern struct {
    ...
    pub fn SetFlyout(self: *@This(), value: ?*anyopaque) !void {
        try hrCheck(self.lpVtbl.SetFlyout(@ptrCast(self), value));
    }
};
...
pub const IMenuFlyout = extern struct {
    ...
    pub fn Items(self: *@This()) !*IVector {
        var out: ?*anyopaque = null;
        try hrCheck(self.lpVtbl.Items(@ptrCast(self), &out));
        return @ptrCast(@alignCast(out orelse return error.WinRTFailed));
    }
};

pub const IMenuFlyoutItem = extern struct {
    pub const IID = GUID{ .data1 = 0x4252df5a, .data2 = 0x44f9, .data3 = 0x5ee8, .data4 = .{ 0xb1, 0xcc, 0x53, 0xde, 0x9a, 0xaa, 0x40, 0x95 } };
    lpVtbl: *const VTable,
    pub const VTable = extern struct {
        QueryInterface: *const fn (*anyopaque, *const GUID, *?*anyopaque) callconv(.winapi) HRESULT,
        AddRef: *const fn (*anyopaque) callconv(.winapi) u32,
        ...
        GetTrustLevel: VtblPlaceholder,
        // slot 6-7: Text
        Text: *const fn (*anyopaque, *HSTRING) callconv(.winapi) HRESULT,
        SetText: *const fn (*anyopaque, HSTRING) callconv(.winapi) HRESULT,
        // slot 8-9: Command
        Command: VtblPlaceholder,
        SetCommand: VtblPlaceholder,
        // slot 10-11: CommandParameter
        CommandParameter: VtblPlaceholder,
        SetCommandParameter: VtblPlaceholder,
        // slot 12-13: Icon
        Icon: VtblPlaceholder,
        SetIcon: VtblPlaceholder,
        // slot 14-15: KeyboardAcceleratorTextOverride
        KeyboardAcceleratorTextOverride: VtblPlaceholder,
        SetKeyboardAcceleratorTextOverride: VtblPlaceholder,
        // slot 16: TemplateSettings
        TemplateSettings: VtblPlaceholder,
        // slot 17-18: Click event
        Click: *const fn (*anyopaque, ?*anyopaque, *EventRegistrationToken) callconv(.winapi) HRESULT,
        RemoveClick: *const fn (*anyopaque, EventRegistrationToken) callconv(.winapi) HRESULT,
    };
    pub fn release(self: *@This()) void {
    ...
    pub fn SetText(self: *@This(), value: HSTRING) !void {
        try hrCheck(self.lpVtbl.SetText(@ptrCast(self), value));
    }
    pub fn Click(self: *@This(), handler: ?*anyopaque, token: *EventRegistrationToken) !void {
        try hrCheck(self.lpVtbl.Click(@ptrCast(self), handler, token));
    }
};

pub const IMenuFlyoutSeparator = extern struct {
    pub const IID = GUID{ .data1 = 0x3eaf5fd5, .data2 = 0x935e, .data3 = 0x5ed7, .data4 = .{ 0x8d, 0x05, 0xf6, 0xba, 0xfa, 0x93, 0x6d, 0x25 } };
    lpVtbl: *const VTable,
    pub const VTable = extern struct {
        QueryInterface: *const fn (*anyopaque, *const GUID, *?*anyopaque) callconv(.winapi) HRESULT,
        AddRef: *const fn (*anyopaque) callconv(.winapi) u32,
        ...
        GetRuntimeClassName: VtblPlaceholder,
        GetTrustLevel: VtblPlaceholder,
        // IMenuFlyoutSeparator has no additional methods
    };
    pub fn release(self: *@This()) void {
        comRelease(self);
    }
